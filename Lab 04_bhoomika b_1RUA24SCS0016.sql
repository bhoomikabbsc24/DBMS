...
SELECT 
    ...
    Salary + (Salary * 0.10) AS TotalSalary
FROM Employees;
-- output
...
SELECT 
    ...
    Salary,
    Salary * 0.15 AS Tax,
    Salary - (Salary * 0.15) AS NetSalary
FROM Employees;
-- output 
...
-- output 
1002	Binay	45	80000.00	HR
1003	Charlie	32	55000.00	Finance
1004	Dhruv	38	75000.00	HR
...
-- output
1002	Binay	45	80000.00	HR	456 Elm St, Chicago
1003	Charlie	32	55000.00	Finance	789 Oak St, Los Angeles
